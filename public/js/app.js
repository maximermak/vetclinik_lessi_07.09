(function () {
  ...
  // Назви місяців обома мовами: сторінка існує в українській і
  // російській версіях, мова приходить у data-lang самого віджета.
  var CAL = {
    uk: {
      nom: ['Січень', 'Лютий', 'Березень', 'Квітень', 'Травень', 'Червень',
            'Липень', 'Серпень', 'Вересень', 'Жовтень', 'Листопад', 'Грудень'],
      gen: ['січня', 'лютого', 'березня', 'квітня', 'травня', 'червня',
            'липня', 'серпня', 'вересня', 'жовтня', 'листопада', 'грудня'],
      week: ['нд', 'пн', 'вт', 'ср', 'чт', 'пт', 'сб'],
      pick: 'Спершу оберіть день'
    },
    ru: {
  ...
  function initDatepick(root) {
    var L = CAL[root.dataset.lang] || CAL.uk;
    var MONTHS_NOM = L.nom, MONTHS_GEN = L.gen, WEEK_SHORT = L.week;
    var hours = {};
